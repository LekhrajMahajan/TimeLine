                ...
                <div className="relative isolate overflow-hidden bg-gray-900 border border-gray-700 px-6 py-12 text-center shadow-2xl rounded-3xl sm:px-12">
                    ...
                    <form className="mt-8 text-left space-y-6" onSubmit={handleSubmit}>
                        <div>
                            ...
                            <input type="text" required className="mt-2 w-full rounded-full border-0 bg-white/5 px-4 py-3 text-white focus:ring-2 focus:ring-yellow-500" placeholder="Your Name" value={fullName} onChange={(e) => setFullName(e.target.value)} />
                        </div>
                        <div>
                    ...
                    <p className="mt-8 text-center text-sm text-gray-400">
                        ...
                        <Link to="/login" className="font-semibold text-blue-500 hover:text-blue-400 hover:underline">Log in</Link>
                    </p>
                </div>
            </div>
        </div>
